...
<html lang="zxx" class="no-js">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/depan/css/linearicons.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/depan/css/font-awesome.min.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/depan/css/magnific-popup.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/depan/css/nice-select.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/depan/css/jquery-ui.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/depan/css/bootstrap.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/depan/css/main.css">
    </head>
    <body>
        <!-- Start Header Area -->
            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="header-top d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>images/logo-wahana.png" alt=""></a>
                        </div>
        ...
        <!-- start banner Area -->
        <section class="banner-area relative" style="background: url(<?php echo $pic1; ?>)">
                        ...
                        <div class="single-project">
                            <div class="content">
                                <a href="#" target="_blank">
                                    ...
                                    <img class="content-image img-fluid d-block mx-auto" src="<?php echo base_url(); ?>assets/depan/img/p1.jpg" alt="">
                                    <div class="content-details fadeIn-bottom">
                                        <div class="head-btn btn text-uppercase">Donate Now</div>
                                    </div>
                                </a>
                             </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 project-wrap">
                            <div class="single-project">
                                <div class="content">
                                    <a href="#" target="_blank">
                                        <div class="content-overlay"></div>
                                        <img class="content-image img-fluid d-block mx-auto" src="<?php echo base_url(); ?>assets/depan/img/p2.jpg" alt="">
                                        <div class="content-details fadeIn-bottom">
                                            <div href="#" class="head-btn btn text-uppercase">Donate Now</div>
                                        </div>
                                    </a>
                                 </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 project-wrap">
                            <div class="single-project">
                                <div class="content">
                                    <a href="#" target="_blank">
                                        <div class="content-overlay"></div>
                                        <img class="content-image img-fluid d-block mx-auto" src="<?php echo base_url(); ?>assets/depan/img/p3.jpg" alt="">
                                        <div class="content-details fadeIn-bottom">
                                            <div href="#" class="head-btn btn text-uppercase">Donate Now</div>
                                        </div>
                                    </a>
            ...
            <div class="container-fluid">
                <div class="row d-flex justify-content-end align-items-center">
                    <div class="col-lg-6 col-md-12 about-left no-padding">
                        <img class="img-fluid" src="<?php echo base_url(); ?>assets/depan/img/about-img.jpg" alt="">
                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 vol-wrap">
                        <div class="single-vol">
                            <div class="content">
                                <a href="#" target="_blank">
                                    <div class="content-overlay"></div>
                                    <img class="content-image img-fluid d-block mx-auto" src="<?php echo base_url(); ?>assets/depan/img/v1.jpg" alt="">
                                    <div class="content-details fadeIn-bottom">
                                        <h4>Andy Florence</h4>
                    ...
                    <div class="col-lg-3 col-md-3 vol-wrap">
                        <div class="single-vol">
                            <div class="content">
                                <a href="#" target="_blank">
                                  <div class="content-overlay"></div>
                                  <img class="content-image img-fluid d-block mx-auto" src="<?php echo base_url(); ?>assets/depan/img/v2.jpg" alt="">
                                    <div class="content-details fadeIn-bottom">
                                        <h4>Andy Florence</h4>
                                        <p>inappropriate behavior</p>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 vol-wrap">
                        <div class="single-vol">
                            <div class="content">
                                <a href="#" target="_blank">
                                  <div class="content-overlay"></div>
                                    <img class="content-image img-fluid d-block mx-auto" src="<?php echo base_url(); ?>assets/depan/img/v3.jpg" alt="">
                                    <div class="content-details fadeIn-bottom">
                                        <h4>Andy Florence</h4>
                                        <p>inappropriate behavior</p>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 vol-wrap">
                        <div class="single-vol">
                            <div class="content">
                                <a href="#" target="_blank">
                                    <div class="content-overlay"></div>
                                    <img class="content-image img-fluid d-block mx-auto" src="<?php echo base_url(); ?>assets/depan/img/v4.jpg" alt="">
                                    <div class="content-details fadeIn-bottom">
                                        <h4>Andy Florence</h4>
                                        <p>inappropriate behavior</p>
                                    </div>
                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-lg-6 contact-right">
                        ...
                        <p class="payment-method">
                            We Accept :   <img src="<?php echo base_url(); ?>assets/depan/img/payment.png" alt="">
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row d-flex flex-column justify-content-center">
                    ...
                    <p class="footer-text m-0">
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved by <a href="https://pramediaenginering.com" target="_blank">PRAMEDIA</a>
                    </p>
                </div>
            </div>
        </footer>
        ...
        <script src="<?php echo base_url(); ?>assets/depan/js/vendor/jquery-2.2.4.min.js"></script>
        <script src="<?php echo base_url(); ?>assets/depan/js/popper.min.js"></script>
        <script src="<?php echo base_url(); ?>assets/depan/js/vendor/bootstrap.min.js"></script>
        <script src="<?php echo base_url(); ?>assets/depan/js/jquery.ajaxchimp.min.js"></script>
        <script src="<?php echo base_url(); ?>assets/depan/js/jquery.nice-select.min.js"></script>
        <script src="<?php echo base_url(); ?>assets/depan/js/jquery.sticky.js"></script>
        <script src="<?php echo base_url(); ?>assets/depan/js/parallax.min.js"></script>
        <script src="<?php echo base_url(); ?>assets/depan/js/jquery-ui.js"></script>
        <script src="<?php echo base_url(); ?>assets/depan/js/jquery.magnific-popup.min.js"></script>
